 ...
 */
std::string SmallShell::substituteAliases(const std::string &cmd_line)
{
...
bool checker(string cmd_s)
{
    ...
    return (cmd == "showpid&") || (cmd == "cd&") || (cmd == "pwd&") || (cmd == "fg&") || (cmd == "bg&") || (cmd == "chprompt&") || (cmd == "kill&") || (cmd == "quit&") || (cmd == "head&");
}
...
//-----------------------------------------------------------------------------------
AliasCommand::AliasCommand(const char *cmd_line) : Command(cmd_line) {}
...
AlarmList::AlarmEntry::AlarmEntry(std::string command, time_t time_created, time_t duration, pid_t pid) : command(command), time_created(time_created), duration(duration), pid(pid)
{
